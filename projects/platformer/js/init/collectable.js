(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.db, 300, 280, 7, 0.60);
        collectable.create(type.grace, 400, 580, 8, 0.40);
        collectable.create(type.kennedi, 600, 380, 9, 0.30);
        collectable.create(type.max, 800, 180, 8, 0.20);
